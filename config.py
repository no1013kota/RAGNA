...
try:
    GUILD_ID = int(os.getenv("DISCORD_GUILD_ID", "1510205946054574110"))
...
# 性別
ROLE_MALE = 1514242116899962890                   # 男性
ROLE_FEMALE = 1514242158452801658                 # 女性
...
# ==================================================
# クラス管理
PERMISSION_CLASS_MANAGEMENT = [
ROLE_MANAGER,
ROLE_EVALUATION_MANAGER
]

# 招待報酬
PERMISSION_INVITE_REWARD = [
ROLE_MANAGER,
ROLE_EVALUATION_MANAGER
]
